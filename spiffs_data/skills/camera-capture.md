...
Camera URL default: `http://192.168.3.44/capture` — update if your camera has a different address.
...
1. Use http_request to fetch the camera snapshot:
   → http_request url="http://192.168.3.44/capture" method="GET" enable_image_analysis="true"
