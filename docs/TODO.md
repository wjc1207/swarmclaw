...
- Implemented: `tools/tool_web_search.c` — Tavily (default) + Brave (optional) Search API via HTTPS (direct + proxy support)
...
- [x] Tool Registry + web_search tool (Tavily default + Brave optional)
...
- [x] HTTP CONNECT Proxy (Telegram + Claude API + Tavily/Brave Search via proxy tunnel)
- [x] OTA Update
